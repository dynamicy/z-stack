...
#define LED1_LOW          ACTIVE_LOW
#define LED1_HIGH         ACTIVE_HIGH
/* LED_2 */
#define LED2_BV           BV(1)
#define LED2_SBIT         P1_1
#define LED2_DDR          P1DIR
#define LED2_LOW          ACTIVE_LOW
#define LED2_HIGH         ACTIVE_HIGH
/* LED_3 */
#define LED3_BV           BV(2)
#define LED3_SBIT         P1_2
#define LED3_DDR          P1DIR
#define LED3_LOW          ACTIVE_LOW
#define LED3_HIGH         ACTIVE_HIGH
/* LED_4 */
#define LED4_BV           BV(3)
#define LED4_SBIT         P1_3
#define LED4_DDR          P1DIR
#define LED4_LOW          ACTIVE_LOW
#define LED4_HIGH         ACTIVE_HIGH
...
{                                                                \
  ...
  CLKCONCMD = (0x00 | OSC_32KHZ); /* Select 32MHz XOSC and the source for 32K clock */            \
  while (CLKCONSTA != (0x00 | OSC_32KHZ)); /* Wait for the change to be effective */              \
...
#define HAL_debounce(expr)    { char i; for (i=0; i<50; i++) { if (!(expr)) i = 0; } } //MCU KIT-2 switch
...
#define HAL_TURN_OFF_LED1()       st( LED1_SBIT = LED1_LOW(0); )
#define HAL_TURN_OFF_LED2()       st( LED2_SBIT = LED2_LOW(0); )
#define HAL_TURN_OFF_LED3()       st( LED3_SBIT = LED3_LOW(0); )
#define HAL_TURN_OFF_LED4()       st( LED4_SBIT = LED4_LOW(0); )

#define HAL_TURN_ON_LED1()        st( LED1_SBIT = LED1_HIGH (1); )
#define HAL_TURN_ON_LED2()        st( LED2_SBIT = LED2_HIGH (1); )
#define HAL_TURN_ON_LED3()        st( LED3_SBIT = LED3_HIGH (1); )
#define HAL_TURN_ON_LED4()        st( LED4_SBIT = LED4_HIGH (1); )
...
/* Set to TRUE enable KEYPAD usage, FALSE disable it */
//#ifndef HAL_KEYPAD
//  #define HAL_KEYPAD TRUE
//#endif
