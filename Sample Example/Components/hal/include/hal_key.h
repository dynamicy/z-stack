 ...
 **************************************************************************************************/
/* ----------- Switch Button ----------*/
#define HAL_KEY_SW_1_PORT       P2   // Button K1
#define HAL_KEY_SW_1_PIN        BV(3)
#define HAL_KEY_SW_1_DIR        P2DIR
#define HAL_KEY_SW_1_SEL        P2SEL
#define HAL_KEY_SW_2_PORT       P2   // Button K2
#define HAL_KEY_SW_2_PIN        BV(4)
#define HAL_KEY_SW_2_DIR        P2DIR
#define HAL_KEY_SW_2_SEL        P2SEL

/* ----------- Switch Push ------------*/
#define HAL_SW_1_PUSH()          (!(HAL_KEY_SW_1_PORT & HAL_KEY_SW_1_PIN))
#define HAL_SW_2_PUSH()          (!(HAL_KEY_SW_2_PORT & HAL_KEY_SW_2_PIN))

/* ----------- Switch Input/Output Setting --------------*/
#define SWITCH1_INPUT()  	st(P2SEL &= ~BV(3); P2DIR &= ~BV(3);)
#define SWITCH2_INPUT()	        st(P2SEL &= ~BV(4); P2DIR &= ~BV(4);)
...
/* KeyPad (keys) */
#define HAL_KEY_SW_1 0x01  // Keypad button2(Joystick up)
#define HAL_KEY_SW_2 0x02  // Keypad button6(Joystick right)
#define HAL_KEY_SW_5 0x04  // Keypad button5(Joystick center)
#define HAL_KEY_SW_4 0x08  // Keypad button4(Joystick left)
#define HAL_KEY_SW_3 0x10  // Keypad button8(Joystick down)
#define HAL_KEY_SW_6 0x20  // Button S1 if available
#define HAL_KEY_SW_7 0x40  // Button S2 if available

/* MCU-2530 K1 and K2 */
//Home Automation switch control
#define HAL_KEY_SW1  0x01  // Switch K1(Joystick up)
#define HAL_KEY_SW2  0x08  // Switch K2(Joystick left)
