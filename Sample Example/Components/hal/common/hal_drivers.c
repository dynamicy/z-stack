...
#if defined(M140) || defined (M200) || defined (M170) // SensorApp example include header file
  #include "M140.h"
  #include "M170.h"
  #include "M200.h"
#endif
...
/**************************************************************************************************
 * @fn      Hal_DriverInit (ªì©l¤ÆµwÅéªºÅX°Êµ{§Ç, ¨Ï¥ÎªÌ¥i¦b¦¹¨ç¼Æ²K¥[¬ÛÃöµwÅé)
 *
...
/**************************************************************************************************
 * @fn      Hal_ProcessEvent (¦bOSALµn°OHAL¬ÛÃöªºªì©l¤Æ¨Æ¥ó)
 *
...
/**************************************************************************************************
 * @fn      Hal_ProcessPoll (¦¹¨ç¼Æ¥D­n¬O³z¹LOSAL¶i¦æ½ü¸ß)
 *
