 ...
 *                        ZDP_IEEEADDR_REQTYPE_SINGLE : 該device的short address and externed address              
 *                        ZDP_IEEEADDR_REQTYPE_EXTENDED : 該device的short address and externed address及相關device的short address
 *
 * @param       SecurityEnable - Security Options
 *
 * @return      afStatus_t
