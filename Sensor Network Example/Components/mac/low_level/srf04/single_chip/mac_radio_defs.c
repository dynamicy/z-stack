 ...
 * ------------------------------------------------------------------------------------------------
 */
#if defined MAC_RUNTIME_CC2591 || defined MAC_RUNTIME_CC2590 || (!defined HAL_PA_LNA && !defined HAL_PA_LNA_CC2590)
...
MAC_INTERNAL_API void macRadioTurnOnPower(void)
{
  ...
  { /* either if compound statement or non-conditional compound statement */
    ...
    /* (Re-)Configure PA and LNA control signals to RF frontend chips. Note that The register values
       are not retained during sleep. */
